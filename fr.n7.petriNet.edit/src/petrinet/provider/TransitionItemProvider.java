 ...
 * @generated
 */
public class TransitionItemProvider extends NetworkElementItemProvider {
	/**
	...
	protected void addReadArcsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_ReadArcs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_ReadArcs_feature", "_UI_Transition_type"),
				 PetrinetPackage.Literals.TRANSITION__READ_ARCS,
				 true,
				 false,
				 true,
				 null,
