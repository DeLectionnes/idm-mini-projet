 ...
 * </p>
 * <ul>
 *   <li>{@link petrinet.impl.ArcImpl#getTowardState <em>Toward State</em>}</li>
 *   <li>{@link petrinet.impl.ArcImpl#getTowardTransition <em>Toward Transition</em>}</li>
 *   <li>{@link petrinet.impl.ArcImpl#getTransition <em>Transition</em>}</li>
 *   <li>{@link petrinet.impl.ArcImpl#getState <em>State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcImpl extends NetworkElementImpl implements Arc {
	/**
	 * The default value of the '{@link #getTowardState() <em>Toward State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTowardState()
	 * @generated
	 * @ordered
	 */
	protected static final int TOWARD_STATE_EDEFAULT = 0;

	/**
	 * The cached value of the '{@link #getTowardState() <em>Toward State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTowardState()
	 * @generated
	 * @ordered
	 */
	protected int towardState = TOWARD_STATE_EDEFAULT;
	 ...
	 * @generated
	 */
	public void setTowardState(int newTowardState) {
		int oldTowardState = towardState;
		towardState = newTowardState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__TOWARD_STATE, oldTowardState, towardState));
	}
	...
	public void setTowardTransition(int newTowardTransition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__TOWARD_TRANSITION, oldTowardTransition, towardTransition));
	}
	...
	public State getState() {
		if (state != null && state.eIsProxy()) {
			...
			if (state != oldState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PetrinetPackage.ARC__STATE, oldState, state));
			}
		}
		return state;
	}
	...
	public NotificationChain basicSetState(State newState, NotificationChain msgs) {
		...
		state = newState;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__STATE, oldState, newState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setState(State newState) {
		if (newState != state) {
			NotificationChain msgs = null;
			if (state != null)
				msgs = ((InternalEObject)state).eInverseRemove(this, PetrinetPackage.STATE__ARCS, State.class, msgs);
			if (newState != null)
				msgs = ((InternalEObject)newState).eInverseAdd(this, PetrinetPackage.STATE__ARCS, State.class, msgs);
			msgs = basicSetState(newState, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.ARC__STATE, newState, newState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case PetrinetPackage.ARC__STATE:
				if (state != null)
					msgs = ((InternalEObject)state).eInverseRemove(this, PetrinetPackage.STATE__ARCS, State.class, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PetrinetPackage.ARC__TOWARD_STATE:
				setTowardState((Integer)newValue);
				return;
			case PetrinetPackage.ARC__TOWARD_TRANSITION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case PetrinetPackage.ARC__TOWARD_STATE:
				setTowardState(TOWARD_STATE_EDEFAULT);
				return;
			case PetrinetPackage.ARC__TOWARD_TRANSITION:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case PetrinetPackage.ARC__TOWARD_STATE:
				return towardState != TOWARD_STATE_EDEFAULT;
			case PetrinetPackage.ARC__TOWARD_TRANSITION:
