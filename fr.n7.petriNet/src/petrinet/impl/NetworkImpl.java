 ...
 *   <li>{@link petrinet.impl.NetworkImpl#getNetworkElement <em>Network Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkImpl extends MinimalEObjectImpl.Container implements Network {
	...
	/**
	 * The cached value of the '{@link #getNetworkElement() <em>Network Element</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<NetworkElement> networkElement;
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetrinetPackage.NETWORK__NETWORK_ELEMENT:
				return ((InternalEList<?>)getNetworkElement()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case PetrinetPackage.NETWORK__NAME:
				...
				return;
			case PetrinetPackage.NETWORK__NETWORK_ELEMENT:
				getNetworkElement().clear();
				getNetworkElement().addAll((Collection<? extends NetworkElement>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case PetrinetPackage.NETWORK__NETWORK_ELEMENT:
				return networkElement != null && !networkElement.isEmpty();
		}
