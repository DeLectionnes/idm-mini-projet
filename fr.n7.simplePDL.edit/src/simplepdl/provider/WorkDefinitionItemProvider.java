	...
	protected void addRessourceNeededPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_WorkDefinition_ressourceNeeded_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_WorkDefinition_ressourceNeeded_feature", "_UI_WorkDefinition_type"),
				 SimplepdlPackage.Literals.WORK_DEFINITION__RESSOURCE_NEEDED,
				 true,
				 false,
				 true,
				 null,
