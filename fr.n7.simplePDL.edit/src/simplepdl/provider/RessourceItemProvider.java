...
public class RessourceItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLinkToSequencePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Link To Sequence feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLinkToSequencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_linkToSequence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_linkToSequence_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__LINK_TO_SEQUENCE,
				 true,
				 false,
				 true,
				 null,
