 ...
 *   <li>{@link simplepdl.impl.RessourceImpl#getLinkToSequence <em>Link To Sequence</em>}</li>
...
public class RessourceImpl extends ProcessElementImpl implements Ressource {
	...
	/**
	 * The cached value of the '{@link #getLinkToSequence() <em>Link To Sequence</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLinkToSequence()
	 * @generated
	 * @ordered
	 */
	protected EList<RessourceSupply> linkToSequence;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimplepdlPackage.RESSOURCE__NAME:
				...
				return;
			case SimplepdlPackage.RESSOURCE__LINK_TO_SEQUENCE:
				getLinkToSequence().clear();
				getLinkToSequence().addAll((Collection<? extends RessourceSupply>)newValue);
				return;
			case SimplepdlPackage.RESSOURCE__QUANTITY:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.RESSOURCE__LINK_TO_SEQUENCE:
				return linkToSequence != null && !linkToSequence.isEmpty();
			case SimplepdlPackage.RESSOURCE__QUANTITY:
