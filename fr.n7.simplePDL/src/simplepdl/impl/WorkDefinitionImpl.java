 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getRessourceNeeded <em>Ressource Needed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getRessourceNeeded() <em>Ressource Needed</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EList<RessourceSupply> ressourceNeeded;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCE_NEEDED:
				getRessourceNeeded().clear();
				getRessourceNeeded().addAll((Collection<? extends RessourceSupply>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESSOURCE_NEEDED:
				return ressourceNeeded != null && !ressourceNeeded.isEmpty();
		}
