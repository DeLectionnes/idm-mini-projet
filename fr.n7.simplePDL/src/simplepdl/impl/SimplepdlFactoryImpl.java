...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.RESSOURCE_SUPPLY: return createRessourceSupply();
			default:
	 ...
	 * @generated
	 */
	public RessourceSupply createRessourceSupply() {
		RessourceSupplyImpl ressourceSupply = new RessourceSupplyImpl();
		return ressourceSupply;
	}
