...
public class SimplepdlAdapterFactory extends AdapterFactoryImpl {
	...
	protected SimplepdlSwitch<Adapter> modelSwitch =
		new SimplepdlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRessourceSupply(RessourceSupply object) {
				return createRessourceSupplyAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link simplepdl.RessourceSupply <em>Ressource Supply</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRessourceSupplyAdapter() {
		return null;
	}
