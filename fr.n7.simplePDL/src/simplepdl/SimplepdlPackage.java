...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Ressource Needed</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__RESSOURCE_NEEDED = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The feature id for the '<em><b>Link To Sequence</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE__LINK_TO_SEQUENCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESSOURCE__QUANTITY = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.RessourceSupplyImpl <em>Ressource Supply</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.RessourceSupplyImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceSupply()
	 * @generated
	 */
	int RESSOURCE_SUPPLY = 6;
	 ...
	 * @ordered
	 */
	int RESSOURCE_SUPPLY__QUANTITY_NEEDED = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE_SUPPLY__SUCCESSOR = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESSOURCE_SUPPLY__PREDECESSOR = PROCESS_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>Ressource Supply</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_SUPPLY_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 3;

	/**
	 * The number of operations of the '<em>Ressource Supply</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE_SUPPLY_OPERATION_COUNT = PROCESS_ELEMENT_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.WorkDefinition#getRessourceNeeded <em>Ressource Needed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Ressource Needed</em>'.
	 * @see simplepdl.WorkDefinition#getRessourceNeeded()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_RessourceNeeded();
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getLinkToSequence <em>Link To Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Link To Sequence</em>'.
	 * @see simplepdl.Ressource#getLinkToSequence()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_LinkToSequence();
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.RessourceSupply <em>Ressource Supply</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Ressource Supply</em>'.
	 * @see simplepdl.RessourceSupply
	 * @generated
	 */
	EClass getRessourceSupply();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.RessourceSupply#getQuantityNeeded <em>Quantity Needed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Quantity Needed</em>'.
	 * @see simplepdl.RessourceSupply#getQuantityNeeded()
	 * @see #getRessourceSupply()
	 * @generated
	 */
	EAttribute getRessourceSupply_QuantityNeeded();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourceSupply#getSuccessor <em>Successor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Successor</em>'.
	 ...
	 * @generated
	 */
	EReference getRessourceSupply_Successor();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.RessourceSupply#getPredecessor <em>Predecessor</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Predecessor</em>'.
	 ...
	 * @generated
	 */
	EReference getRessourceSupply_Predecessor();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Ressource Needed</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__RESSOURCE_NEEDED = eINSTANCE.getWorkDefinition_RessourceNeeded();
		...
		/**
		 * The meta object literal for the '<em><b>Link To Sequence</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE__LINK_TO_SEQUENCE = eINSTANCE.getRessource_LinkToSequence();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.RessourceSupplyImpl <em>Ressource Supply</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.RessourceSupplyImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getRessourceSupply()
		 * @generated
		 */
		EClass RESSOURCE_SUPPLY = eINSTANCE.getRessourceSupply();
		 ...
		 * @generated
		 */
		EAttribute RESSOURCE_SUPPLY__QUANTITY_NEEDED = eINSTANCE.getRessourceSupply_QuantityNeeded();
		 ...
		 * @generated
		 */
		EReference RESSOURCE_SUPPLY__SUCCESSOR = eINSTANCE.getRessourceSupply_Successor();
		 ...
		 * @generated
		 */
		EReference RESSOURCE_SUPPLY__PREDECESSOR = eINSTANCE.getRessourceSupply_Predecessor();
